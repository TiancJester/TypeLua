...
namespace TypeLua.Production
{
    ...
    public class Compareexp_Compareexp_Lt_Typeconversionexp : Compare_exp_basisproduction
    {
        ...
        public Compareexp_Compareexp_Lt_Typeconversionexp(Project project, Class @class, GOLD.Token token0,GOLD.Token token1,GOLD.Token token2)
        {
        ...
        public override void ContextVerify(IContext context)
        {
            ...
            {
                throw new SyntaxException("Cannot apply operator '<' here.", this.Lt.Line, this.Lt.Column);
            }
