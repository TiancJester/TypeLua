...
namespace TypeLua.Production
{
    ...
    public class Multexp_Multexp_Times_Jointexp : Mult_exp_basisproduction
    {
        public Token<Mult_exp_basisproduction> Multexp;
        public Token<string> Times;
        public Token<Joint_exp_basisproduction> Jointexp;

        public Multexp_Multexp_Times_Jointexp(Project project, Class @class, GOLD.Token token0,GOLD.Token token1,GOLD.Token token2)
        {
            ...
            this.Times = new Token<string>() {Column = token1.Position().Column,Line = token1 .Position().Line,Symbol = (string)token1.Data};
            this.Children.Add(this.Times);
        ...
        public override void ContextVerify(IContext context)
        {
            ...
            {
                throw new SyntaxException("Cannot apply operator '*' here.", this.Times.Line, this.Times.Column);
            }
