...
namespace TypeLua.Production
{
    ...
    public class Compareexp_Compareexp_Gteq_Typeconversionexp : Compare_exp_basisproduction
    {
        public Token<Compare_exp_basisproduction> Compareexp;
        public Token<string> Gteq;
        public Token<Type_conversion_exp_basisproduction> Typeconversionexp;

        public Compareexp_Compareexp_Gteq_Typeconversionexp(Project project, Class @class, GOLD.Token token0,GOLD.Token token1,GOLD.Token token2)
        {
            ...
            this.Gteq = new Token<string>() {Column = token1.Position().Column,Line = token1 .Position().Line,Symbol = (string)token1.Data};
            this.Children.Add(this.Gteq);
        ...
        public override void ContextVerify(IContext context)
        {
            ...
            {
                throw new SyntaxException("Cannot apply operator '>=' here.", this.Gteq.Line, this.Gteq.Column);
            }
