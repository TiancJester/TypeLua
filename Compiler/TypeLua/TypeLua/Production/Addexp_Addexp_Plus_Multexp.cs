...
namespace TypeLua.Production
{
    ...
    public class Addexp_Addexp_Plus_Multexp : Add_exp_basisproduction
    {
        public Token<Add_exp_basisproduction> Addexp;
        public Token<string> Plus;
        public Token<Mult_exp_basisproduction> Multexp;

        public Addexp_Addexp_Plus_Multexp(Project project, Class @class, GOLD.Token token0,GOLD.Token token1,GOLD.Token token2)
        {
            ...
            this.Plus = new Token<string>() {Column = token1.Position().Column,Line = token1 .Position().Line,Symbol = (string)token1.Data};
            this.Children.Add(this.Plus);
        ...
        public override void ContextVerify(IContext context)
        {
            ...
            {
                throw new SyntaxException("Cannot apply operator '+' here.", this.Plus.Line, this.Plus.Column);
            }
