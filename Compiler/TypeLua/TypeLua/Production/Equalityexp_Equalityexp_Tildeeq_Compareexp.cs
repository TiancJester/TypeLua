...
namespace TypeLua.Production
{
    ...
    public class Equalityexp_Equalityexp_Tildeeq_Compareexp : Equality_exp_basisproduction
    {
        public Token<Equality_exp_basisproduction> Equalityexp;
        public Token<string> Tildeeq;
        public Token<Compare_exp_basisproduction> Compareexp;

        public Equalityexp_Equalityexp_Tildeeq_Compareexp(Project project, Class @class, GOLD.Token token0,GOLD.Token token1,GOLD.Token token2)
        {
            ...
            this.Tildeeq = new Token<string>() {Column = token1.Position().Column,Line = token1 .Position().Line,Symbol = (string)token1.Data};
            this.Children.Add(this.Tildeeq);
