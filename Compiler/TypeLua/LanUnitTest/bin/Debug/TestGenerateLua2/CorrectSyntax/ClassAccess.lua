--== start class define ==--
local ClassA = tlclass("TestGenerateLua2.CorrectSyntax.ClassAccess","TestGenerateLua2.Common.Fruits.Apple")
...
function ClassA._loadreference()
    ...
    Fruit = tlload("TestGenerateLua2.Common.Fruits.Fruit")
    SystemUtil = tlload("TestGenerateLua2.Common.System.SystemUtil")
end
--== class fileds ==--
ClassA.p = nil
--== constructor ==--
